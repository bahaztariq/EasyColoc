        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-blue-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-sm text-gray-500 uppercase font-bold">{{ __('Total Users') }}</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-green-500">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-sm text-gray-500 uppercase font-bold">{{ __('Total Colocations') }}</p>
                            <p class="text-3xl font-semibold text-gray-800">{{ $totalColocations }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-medium mb-4">{{ __('Manage Users') }}</h3>
